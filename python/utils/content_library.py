...
_TAG_SYNONYMS: dict[str, tuple[str, ...]] = {
    "закаливание": ("закал", "холодн", "лёд", "лед", "мороз", "терморегул"),
    "снег": ("снег",),
    "бокс": ("бокс", "единоборств", "удар"),
    "пляж": ("пляж", "песок", "берег"),
    "вода": ("в воде", "по воде", "по морю", "вода"),
    "роса": ("роса", "росе"),
    "дыхание": ("дыхан", "дышать", "вдох", "выдох"),
    "обувь": ("кроссовк", "обув", "босиком"),
}
